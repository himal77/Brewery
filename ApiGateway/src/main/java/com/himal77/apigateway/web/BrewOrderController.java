...
public class BrewOrderController {
    ...
    @GetMapping
    public ResponseEntity<Object> findall() throws URISyntaxException {
    ...
    @PostMapping
    public ResponseEntity<Object> brew(@RequestBody BrewOrder brewOrder) throws URISyntaxException{
        URI uri = new URI(baseUrlConfig.getBreworderurl());
